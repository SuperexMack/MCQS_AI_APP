      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm">&copy; {year} Gee-Quizi All rights reserved.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a
                href="https://github.com/SuperexMack"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/mohitsatilinks/"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div>
              <a
                href={`mailto:mohitsati.eth@gmail.com`}
        ...
        <div className="mt-8 pt-8 border-t border-slate-300 text-center text-sm">
          <p>Gee-Quizi is a registered trademark of Gee-Quizi, Inc.</p>
        </div>
      </div>
    </footer>
  );
