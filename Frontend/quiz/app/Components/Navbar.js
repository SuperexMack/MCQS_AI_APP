...
import quizImage from "./bannerwe.png"
import Link from "next/link";

export default function Navbar(){
    return(
        <>
          <div className="w-full h-[100px] flex items-center bg-slate-100 ">
            <Image alt="icon-image" className="h-[120px] w-[400px] ml-[50px]" src={quizImage}></Image>
            <ul className="flex space-x-10 text-[30px] font-bold absolute right-[50px] text-pink-700">
